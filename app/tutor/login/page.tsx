...
export default function TutorLoginPage() {
  ...
  useEffect(() => {
    ...
    // Using Purple/Violet/Indigo shades to match Tutor Theme
    const kiteColors = [
      "text-purple-600",
      "text-violet-600",
      "text-indigo-600",
  ...
  return (
    <div className="min-h-screen relative w-full overflow-hidden bg-gradient-to-br from-purple-50 via-violet-50 to-indigo-50 dark:from-gray-900 dark:via-purple-900 dark:to-violet-900 flex items-center justify-center p-4">
      ...
      {mounted && (
        <div className="absolute inset-0 w-full h-full pointer-events-none overflow-hidden z-0">
          {/* LIGHT MODE: KITES (PURPLE/VIOLET THEME) */}
